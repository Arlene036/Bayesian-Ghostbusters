...
def joinFactors(factors: List[Factor]):
    ...
    # create a new factor, variableDomainsDict就是之前所有factor的variableDomainsDict的并集，这是一个dict的合并，要去重复的key
    new_variableDomainsDict = {}
    for factor in factors:
        new_variableDomainsDict.update(factor.variableDomainsDict()) # 这样写的话，如果有重复的key，就会被覆盖掉，所以不会有重复的key
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        "*** YOUR CODE HERE ***"
        # 把eliminationVariable从unconditionedVariables中去掉
